...
The model is implemented in [Stan](http://mc-stan.org/), a Bayesian modeling language, using the `rstan` package.
...
The function below performs the same operations as `betweenParticipantsPieces` except that it uses $\rho_i$ rather than $\mu_\rho$.
